...
import com.box.l10n.mojito.cli.command.localextraction.LocalExtractionService;
...
public class LocalExtractionCommand extends Command {
    ...
    @Autowired
    LocalExtractionService localExtractionService;
    ...
    public void execute() throws CommandException {
        ...
        consoleWriter.newLine().a("Local extraction for branch: ").fg(Ansi.Color.CYAN).a(extractionName).println();

        LocalExtractionsPaths localExtractionsPaths = new LocalExtractionsPaths(outputDirectoryParam);
        localExtractionService.deleteTargetDirectoryForBranch(localExtractionsPaths, extractionName);
        ...
        for (FileMatch sourceFileMatch : sourceFileMatches) {
            ...
            localExtractionService.convertAndSaveToJsonFile(sourceFileMatch, filterOptions, extractionName, localExtractionsPaths);
        }
